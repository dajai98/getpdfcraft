...
const posts = [
  ...
  { slug: "how-to-remove-password-from-pdf", title: "How to Remove Password from Your Own PDF — Free & Safe", desc: "Safely remove password protection from a PDF you own, step by step.", date: "Jan 25, 2026", tag: "Unlock PDF", tagColor: "#4F46E5", tagBg: "#EEF2FF" },
  ...
  { slug: "how-to-add-password-to-pdf-online", title: "How to Add Password to PDF Online Free", desc: "Add password protection to sensitive PDFs in seconds.", date: "Feb 10, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  ...
  { slug: "why-is-my-pdf-locked", title: "Why Is My PDF Locked? Common Causes & Fixes", desc: "Diagnose why a PDF won't open and how to fix each cause.", date: "Mar 3, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  { slug: "how-to-encrypt-pdf-files-free", title: "How to Encrypt PDF Files Free Online", desc: "Encrypt PDFs with AES-256 encryption, free and private.", date: "Mar 4, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  { slug: "how-to-lock-pdf-for-job-applications", title: "How to Lock PDF for Job Applications", desc: "Protect your resume and application documents before sending.", date: "Mar 5, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  { slug: "how-to-lock-pdf-without-adobe", title: "How to Lock a PDF Without Adobe Acrobat", desc: "Password protect a PDF for free — no Adobe subscription needed.", date: "Mar 6, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  { slug: "how-to-secure-pdf-before-sending-email", title: "How to Secure a PDF Before Sending by Email", desc: "A quick security checklist before you email a sensitive PDF.", date: "Mar 7, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  { slug: "how-to-protect-pdf-from-editing", title: "How to Protect PDF from Editing Free", desc: "Stop unauthorized changes with passwords and watermarks.", date: "Mar 8, 2026", tag: "Security", tagColor: "#DB2777", tagBg: "#FDF2F8" },
  { slug: "password-protect-pdf-on-android", title: "How to Password Protect PDF on Android", desc: "Add password protection to a PDF right from your Android phone.", date: "Mar 9, 2026", tag: "Android", tagColor: "#16A34A", tagBg: "#F0FDF4" },
  { slug: "lock-pdf-on-iphone", title: "How to Lock PDF on iPhone Free (No App Needed)", desc: "Password protect a PDF directly in Safari on iPhone.", date: "Mar 10, 2026", tag: "iPhone", tagColor: "#1D4ED8", tagBg: "#EFF6FF" },
  { slug: "secure-pdf-on-mac", title: "How to Secure PDF on Mac Free (3 Easy Ways)", desc: "Password protect a PDF on Mac using Preview, Terminal, or PDFcraft.", date: "Mar 11, 2026", tag: "Mac", tagColor: "#374151", tagBg: "#F9FAFB" },
  { slug: "how-browser-based-pdf-processing-works", title: "How Browser-Based PDF Processing Works: What Happens to Your File", desc: "A plain-language walkthrough of what actually happens to your file, and how to verify it yourself.", date: "Aug 5, 2026", tag: "How It Works", tagColor: "#0891B2", tagBg: "#ECFEFF" },
  { slug: "pdf-compression-real-test-results", title: "How Much Can You Actually Compress a PDF? Real Test Results", desc: "We ran the real compression code against four PDF types and measured what happened.", date: "Aug 6, 2026", tag: "Tested", tagColor: "#CA8A04", tagBg: "#FEFCE8" },
  { slug: "pdf-tool-not-working-troubleshooting", title: "Why Isn't My PDF Tool Working? A Troubleshooting Guide", desc: "Getting an error or a frozen page? Here's what's actually going wrong and how to fix it.", date: "Aug 7, 2026", tag: "Troubleshooting", tagColor: "#DC2626", tagBg: "#FEF2F2" },
];
            ...
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontSize: 13, color: "#6b7280", margin: 0 }}>{post.desc}</p>
                </div>
