...
export const metadata = {
  title: "How to Compress PDF on iPhone Free (No App) | PDFcraft",
  description: "Compress PDF files on iPhone for free without installing any app. Works in Safari browser. Reduce PDF size instantly.",
  keywords: "compress pdf iphone free, reduce pdf size iphone, compress pdf safari iphone, shrink pdf on iphone",
...
export default function Post() {
  return (
    <BlogPost
      tag="iPhone" tagColor="#1D4ED8" tagBg="#EFF6FF"
      title="How to Compress PDF on iPhone Free (No App)"
      date="February 2026" readTime="3 min read"
      intro="Need to compress a PDF on your iPhone to send by email or WhatsApp? PDFcraft does it for free directly in Safari — no app download needed."
      sections={[
        {
      ...
      ctaText="Compress PDF on iPhone now"
